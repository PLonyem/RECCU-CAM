...
export const metadata: Metadata = { title: "About", description: `Learn about ${institution.legalName} and the verified foundation of this digital platform.` };
        ...
        <Container className="grid gap-10 lg:grid-cols-[1.2fr_.8fr]">
          ...
          <div className="rounded-3xl bg-primary-50 p-7">
            ...
            <dl className="mt-6 space-y-5 text-sm">
              <div><dt className="text-gray-500">Network</dt><dd className="mt-1 font-bold text-primary-900">{institution.displayName}</dd></div>
              <div><dt className="text-gray-500">Headquarters location</dt><dd className="mt-1 font-bold text-primary-900">{institution.location.city}, {institution.location.country}</dd></div>
              <div><dt className="text-gray-500">Approval order</dt><dd className="mt-1 font-bold text-primary-900">{institution.approval.order}</dd></div>
              <div><dt className="text-gray-500">Approval date</dt><dd className="mt-1 font-bold text-primary-900">5 April 2018</dd></div>
            </dl>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <article key={title as string} className="rounded-2xl border border-primary-100 bg-white p-6">
                <Icon className="h-6 w-6 text-accent-600" /><h2 className="mt-5 font-bold text-primary-900">{title as string}</h2><p className="mt-2 text-sm leading-6 text-gray-600">{text as string}</p>
              </article>
            ))}
          </div>
