    ...
    <div className="space-y-7">
      ...
      <Card className="p-6">
        ...
        <form action={createComplianceRecord} className="mt-5 grid gap-4 sm:grid-cols-2">
          ...
          <label className="text-xs font-semibold text-slate-600">French — Missing<input name="titleFr" placeholder="Title in French" className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2" /></label>
          ...
          <textarea name="descriptionFr" placeholder="Verified guidance or submission requirement (French)" className="rounded-lg border border-slate-300 px-3 py-2" />
          ...
          {records.map((record) => {
            ...
            <Card key={record.id} className="p-5">
              ...
              <form action={updateComplianceRecord} className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <label className="text-xs font-semibold text-slate-600">{titleFr && descriptionFr ? "French ✓" : "French — Missing"}<input name="titleFr" defaultValue={titleFr} aria-label="Title in French" className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2" /></label>
                ...
                <textarea name="descriptionFr" defaultValue={descriptionFr} aria-label="Description in French" className="rounded-lg border border-slate-300 px-3 py-2" />
