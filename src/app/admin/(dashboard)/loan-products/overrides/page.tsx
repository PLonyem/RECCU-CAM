...
export default function AffiliateLoanOverridesPage() {
  ...
  return <div className="space-y-6">
    ...
    <div className="flex gap-3 rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-900"><ShieldCheck className="h-5 w-5 shrink-0" />Resolution order: RECCU-CAM network policy → versioned loan-product policy → active affiliate override.</div>
