    ...
    <div className="space-y-6">
      ...
      {showForm && <form onSubmit={submit} className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm sm:p-7">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <label className="text-sm font-medium">Product name — French<input required value={form.nameFr} onChange={e=>setForm({...form,nameFr:e.target.value})} className={fieldClass} /></label>
          ...
          <label className="text-sm font-medium">Description — French<textarea required value={form.descriptionFr} onChange={e=>setForm({...form,descriptionFr:e.target.value})} className={areaClass} /></label>
        </div>
        ...
        <div className="mt-4 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <label className="text-sm font-medium sm:col-span-2">Eligibility description — French<textarea value={form.eligibilityDescriptionFr} onChange={e=>setForm({...form,eligibilityDescriptionFr:e.target.value})} className={areaClass} /></label>
        </div>
        <div className="my-7 border-t border-gray-200" />
