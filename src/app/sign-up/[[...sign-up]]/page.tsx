...
export const metadata: Metadata = {
  ...
  description: "Create your RECCU-CAM Digital Network account.",
      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <span>
            ...
            <span className="block text-xs uppercase tracking-[0.16em] text-slate-500">Digital Apex Platform</span>
          </span>
        </Link>
        ...
        {configured ? (
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
            ...
            <h1 className="mt-4 font-display text-xl font-semibold text-institutional">Authentication is not configured</h1>
            <p className="mt-2 text-sm leading-6 text-slate-600">Account creation is unavailable until this deployment&apos;s Clerk keys are configured.</p>
        ...
        <p className="mt-6 text-center text-xs leading-5 text-slate-500">
          Creating an account does not grant access to staff or affiliate workspaces. Access roles are assigned separately by RECCU-CAM.
        </p>
      </div>
    </main>
  );
